...
import { ASSETS_PATHS, ROUTES } from '../../constants/index.js';
import MenacingTexts from './MenacingTexts.jsx';

/**
 * Feature Home
 * Page d'accueil avec sélection du mode de jeu
 */
function Home() {
    return (
