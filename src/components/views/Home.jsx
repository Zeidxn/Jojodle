...
import TextCascade from "../animations/menacing_texts/MenacingTexts.jsx";
    ...
    return (
        <div className="w_100 h_100 flex items_center justify_center">
            ...
            <div className="h_75 w_50 flex flex_col items_center justify_center m_x_auto m_y_auto">
                <img className=" h_375 m_8 scale_hover cursor_pointer " src="/assets/jjba/logo.png" alt="Logo" />
